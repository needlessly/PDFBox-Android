...
public class PDType0Font extends PDFont implements PDVectorFont
{
    ...
    {
        return new PDType0Font(doc, new FileInputStream(file), true, false, null);
    }
    ...
    {
        return new PDType0Font(doc, input, true, false, null);
    }
    ...
    public static PDType0Font load(PDDocument doc, InputStream input, boolean embedSubset)
            throws IOException
    {
        return new PDType0Font(doc, input, embedSubset, false, null);
    }

    public static PDType0Font load(PDDocument doc, InputStream input, boolean embedSubset, Set<Character> characterSet) throws IOException
    {
        return new PDType0Font(doc, input, embedSubset, false, characterSet);
    }

    public static PDType0Font loadVertical(PDDocument doc, File file) throws IOException
    {
        return new PDType0Font(doc, new FileInputStream(file), true, true, null);
    }

    public static PDType0Font loadVertical(PDDocument doc, InputStream input) throws IOException
    {
        return new PDType0Font(doc, input, true, true, null);
    }

    public static PDType0Font loadVertical(PDDocument doc, InputStream input, boolean embedSubset) throws IOException
    {
        return new PDType0Font(doc, input, embedSubset, true, null);
    }

    public static PDType0Font loadVertical(PDDocument doc, InputStream input, boolean embedSubset, Set<Character> characterSet) throws IOException
    {
        return new PDType0Font(doc, input, true, true, characterSet);
    }
     ...
     */
    private PDType0Font(PDDocument document, InputStream ttfStream, boolean embedSubset, boolean vertical, Set<Character> characterSet)
            throws IOException
    {
        ...
        embedder = new PDCIDFontType2Embedder(document, dict, ttfStream, embedSubset, this, vertical, supportedCharCodes);
